...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // at least one lowercase, one uppercase, one digit, and length >= minLength
    ...
    public static List<String> extractEmails(String str) {
        ...
        // matches something@utoronto.ca or something@mail.utoronto.ca
        // at least one non-space, non-@ char before @
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // capture an uppercase letter, then later see the same one again
